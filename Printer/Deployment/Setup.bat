...
CALL :UnitTest "VirtualPrinterSpoolerUnitTest.dll"
if %errorlevel% neq 0 exit /b %errorlevel%
...
:UnitTest
"C:\Program Files\Microsoft Visual Studio\2022\Community\Common7\IDE\CommonExtensions\Microsoft\TestWindow\vstest.console.exe" %~1
